...
The Factory Method pattern defines an interface for creating an object, but lets subclasses decide which class to instantiate. It's commonly mistaken with Abstract Factory or simple Factory patterns.
